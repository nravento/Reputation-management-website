      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <nav aria-label="Services">
            <h2 className="text-white font-bold mb-6 text-sm uppercase tracking-wider">Services</h2>
            <ul className="space-y-4">
              <li>
                <Link href="/services/website-creation" className="text-white/70 hover:text-white transition-colors text-sm flex items-center gap-2 group">
                  Website Creation
                  <ArrowUpRight className="h-3 w-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
              </li>
              <li>
                <Link href="/services/local-seo" className="text-white/70 hover:text-white transition-colors text-sm flex items-center gap-2 group">
                  Local SEO
                  <ArrowUpRight className="h-3 w-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
              </li>
          ...
          <nav aria-label="Company">
            <h2 className="text-white font-bold mb-6 text-sm uppercase tracking-wider">Company</h2>
            <ul className="space-y-4">
          ...
          <div>
            <h2 className="text-white font-bold mb-6 text-sm uppercase tracking-wider">Legal</h2>
            <ul className="space-y-4">
              <li><Link href="/privacy" className="text-white/70 hover:text-white transition-colors text-sm">Privacy</Link></li>
              <li><Link href="/terms" className="text-white/70 hover:text-white transition-colors text-sm">Terms</Link></li>
            </ul>
          </div>
        </div>
